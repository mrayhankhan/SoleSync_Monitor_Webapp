...
void setup() {
  ...
  if (mpuConnected) {
    ...
    // Mode 3: ~42Hz Bandwidth. Removes noise/vibration spikes.
    imu.setDLPFMode(MPU6050_DLPF_BW_42);

    // Auto-Calibration (Must be kept still!)
    ...
    // 6 means "Calibration loops". Higher is more precise but takes longer.
